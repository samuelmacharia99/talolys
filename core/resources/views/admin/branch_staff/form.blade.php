                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="designation" required>
                            ...
                            <option value="{{ Status::ROLE_ACCOUNT_OFFICER }}" @selected(@$staff->designation == Status::ROLE_ACCOUNT_OFFICER)>@lang('Account Officer')</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        <div class="d-flex justify-content-between">
                            <label>@lang('Branch')</label> @can('admin.branch.add')<a href="{{ route('admin.branch.add') }}">@lang('Add New Branch')</a>@endcan
                        </div>
