            ...
            <div class="card bl--5 border--warning">
                <div class="card-body">
                    <p class="text--warning">@lang('The SEO setting is optional for this page. If you don\'t configure SEO here, the global SEO contents will work for this page, which you can configure from') <a
                            href="{{ route('admin.frontend.seo') }}">@lang('System Setting > SEO Configuration').</a></p>
                </div>
            </div>
        </div>
        <div class="col-lg-12">
                            ...
                            <div class="col-xl-4">
                                <div class="form-group">
                                    ...
                                    <x-image-uploader class="w-100" :imagePath="getImage(
                                        getFilePath('seo') .
                                            '/' .
                                            (isset($page->seo_content->image) ? $page->seo_content->image : ''),
                                        getFileSize('seo'),
                            ...
                            <div class="col-xl-8 mt-xl-0 mt-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="social_title"
                                        value="{{ isset($page->seo_content->social_title) ? $page->seo_content->social_title : '' }}" />
                                </div>
                                <div class="form-group">
