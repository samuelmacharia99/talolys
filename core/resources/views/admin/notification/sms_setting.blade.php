                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('Username')"
                                        ...
                                        value="{{ isset(gs('sms_config')->infobip->username) ? gs('sms_config')->infobip->username : '' }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('Password')"
                                        ...
                                        value="{{ isset(gs('sms_config')->infobip->password) ? gs('sms_config')->infobip->password : '' }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('API Key')"
                                        ...
                                        value="{{ isset(gs('sms_config')->message_bird->api_key) ? gs('sms_config')->message_bird->api_key : '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="row mt-4 d-none configForm" id="nexmo">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('API Key')"
                                        name="nexmo_api_key"
                                        value="{{ isset(gs('sms_config')->nexmo->api_key) ? gs('sms_config')->nexmo->api_key : '' }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('API Secret')"
                                        ...
                                        value="{{ isset(gs('sms_config')->nexmo->api_secret) ? gs('sms_config')->nexmo->api_secret : '' }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('Username')"
                                        ...
                                        value="{{ isset(gs('sms_config')->sms_broadcast->username) ? gs('sms_config')->sms_broadcast->username : '' }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('Password')"
                                        ...
                                        value="{{ isset(gs('sms_config')->sms_broadcast->password) ? gs('sms_config')->sms_broadcast->password : '' }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('Account SID')"
                                        name="account_sid"
                                        value="{{ isset(gs('sms_config')->twilio->account_sid) ? gs('sms_config')->twilio->account_sid : '' }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('Auth Token')"
                                        name="auth_token"
                                        value="{{ isset(gs('sms_config')->twilio->auth_token) ? gs('sms_config')->twilio->auth_token : '' }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('From Number')"
                                        name="from"
                                        value="{{ isset(gs('sms_config')->twilio->from) ? gs('sms_config')->twilio->from : '' }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('Username')"
                                        ...
                                        value="{{ isset(gs('sms_config')->text_magic->username) ? gs('sms_config')->text_magic->username : '' }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('Apiv2 Key')"
                                        name="apiv2_key"
                                        value="{{ isset(gs('sms_config')->text_magic->apiv2_key) ? gs('sms_config')->text_magic->apiv2_key : '' }}">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="custom_api_url"
                                            value="{{ isset(gs('sms_config')->custom->url) ? gs('sms_config')->custom->url : '' }}"
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col-md-5">
                                                            <input type="text" name="custom_header_name[]"
                                                                class="form-control"
                                                                value="{{ isset(gs('sms_config')->custom->headers->name[$i]) ? gs('sms_config')->custom->headers->name[$i] : '' }}"
                                                                placeholder="@lang('Headers Name')">
                                                        </div>
                                                        <div class="col-md-5">
                                                            <input type="text" name="custom_header_value[]"
                                                                class="form-control"
                                                                value="{{ isset(gs('sms_config')->custom->headers->value[$i]) ? gs('sms_config')->custom->headers->value[$i] : '' }}"
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col-md-5">
                                                            <input type="text" name="custom_body_name[]"
                                                                class="form-control"
                                                                value="{{ isset(gs('sms_config')->custom->body->name[$i]) ? gs('sms_config')->custom->body->name[$i] : '' }}"
                                                                placeholder="@lang('Body Name')">
                                                        </div>
                                                        <div class="col-md-5">
                                                            <input type="text" name="custom_body_value[]"
                                                                value="{{ isset(gs('sms_config')->custom->body->value[$i]) ? gs('sms_config')->custom->body->value[$i] : '' }}"
