...
@section('panel')
    ...
    <x-data_table.table :data="$loginLogs" :action="$action" :columns="$columns" :columnConfig="true" :tableName="$tableName" :visibleColumns="$visibleColumns" class="table-responsive--md table-responsive"/>
@endsection
