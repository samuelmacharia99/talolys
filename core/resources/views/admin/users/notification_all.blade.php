                    ...
                    <div class="row gy-4 justify-content-center">
                        <div class="col-sm-6">
                            <x-widget link="javascript:void(0)" style="6" icon="fas fa-list" :title="$viaText . ' should be sent'"
                                value="{{ isset($sessionData['total_user']) ? $sessionData['total_user'] : '' }}" bg="primary"
                                :viewMoreIcon=false />
                        </div>
                        <div class="col-sm-6">
                            <x-widget link="javascript:void(0)" style="6" icon="fa-solid fa-envelope-circle-check"
                                :title="$viaText . ' has been sent'"
                                value="{{ isset($sessionData['total_sent']) ? $sessionData['total_sent'] : '' }}" bg="success"
                                :viewMoreIcon=false />
                        </div>
                        <div class="col-sm-6">
                            <x-widget link="javascript:void(0)" style="6" icon="fa-solid fa-paper-plane" :title="$viaText . ' has yet to be sent'"
                                :viewMoreIcon=false
                                value="{{ (isset($sessionData['total_user']) ? $sessionData['total_user'] : 0) - (isset($sessionData['total_sent']) ? $sessionData['total_sent'] : 0) }}"
                                bg="warning" />
                        </div>
                        <div class="col-sm-6">
                            <x-widget link="javascript:void(0)" style="6" icon="fas fa-envelope" :title="$viaText . ' per batch'"
                                value="{{ isset($sessionData['batch']) ? $sessionData['batch'] : '' }}" bg="primary"
                                :viewMoreIcon=false />
                        </div>
                        <div class="col-12">
                            <div class="card">
                                    ...
                                    <div class="coaling-loader flex-column d-flex justify-content-center">
                                        <div class="countdown">
                                            <div class="coaling-time">
                                                <span
                                                    class="coaling-time-count">{{ isset($sessionData['cooling_time']) ? $sessionData['cooling_time'] : '' }}</span>
                                            </div>
                                            <div class="svg-count">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="being_sent_to" required
                                            ...
                                            @foreach ($notifyToUser as $key => $toUser)
                                                <option value="{{ $key }}" @selected(old('being_sent_to', isset($sessionData['being_sent_to']) ? $sessionData['being_sent_to'] : '') == $key)>
                                                    {{ __($toUser) }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-4 start-from-col">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="start"
                                                value="{{ old('start', isset($sessionData['start']) ? $sessionData['start'] : '') }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" name="batch"
                                                    value="{{ old('batch', isset($sessionData['batch']) ? $sessionData['batch'] : '') }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" name="cooling_time"
                                                    value="{{ old('cooling_time', isset($sessionData['batch']) ? $sessionData['batch'] : '') }}"
        ...
        (function($) {
            ...
            $(".notify-form").on("submit", function(e) {
                ...
                if ($('.notification-via.active').data('method') != 'email') {
                    ...
                    setTimeout(() => {
                        $('.nicEdit').val(val);
                        document.getElementsByClassName('notify-form')[0].submit();
                    }, 1);
                }
            });
