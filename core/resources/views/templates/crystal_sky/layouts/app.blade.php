...
<head>
    ...
    <link href="{{ asset(activeTemplate(true) . 'css/custom-fonts.css') }}" rel="stylesheet" />
    ...
    <link href="{{ asset(activeTemplate(true) . 'css/color.php?color=' . gs()->base_color . '&secondColor=' . gs()->secondary_color) }}" rel="stylesheet">
</head>
